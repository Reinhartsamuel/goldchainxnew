...
const data = [
    { id: 1, name: 'FAQ', children: [{ id: 'faq' }] },
    { id: 2, name: 'Tutorial GoldChainX', children: [{ id: 'tutorial' }] },
    { id: 3, name: 'Dokumentasi', children: [{ id: 'dokumentasi' }] },
            ...
            <Container as={Stack} maxW={'6xl'} py={10}>
                <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
                    <Stack align={'flex-start'}>
                        <ListHeader>Profil Saya</ListHeader>
                        {data.map((category) => (
                            <Box
                                key={category.id}
                                href={`/${category.children[0].id}`}
                                as={Link}>
                                {category.name}
                            </Box>
                        ))}
